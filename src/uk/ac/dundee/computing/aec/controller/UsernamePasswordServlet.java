...
@WebServlet(urlPatterns = { "/UsernamePasswordServlet" },initParams = {@WebInitParam(name = "data-source", value = "jdbc/TestDB", description = "Jdbc link to test.db")})
public class UsernamePasswordServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	private DataSource _ds = null;
	
    public UsernamePasswordServlet() 
    {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		RequestDispatcher rd=request.getRequestDispatcher("RenderUsernamePassword.jsp");
