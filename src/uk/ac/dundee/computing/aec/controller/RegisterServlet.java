...
@WebServlet(urlPatterns = { "/RegisterServlet"},initParams = {@WebInitParam(name = "data-source", value = "jdbc/TestDB", description = "Jdbc link to test.db")})
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			//if user already exist, inform user, return to welcome page.
		...
		{
			//add user to database and then forward to members area
			if(Parts.registerUser(username, password))
			{
				request.setAttribute("Members", psl);
